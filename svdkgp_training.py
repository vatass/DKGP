'''
Population SVDKGP Model Training - Production Version 
'''
...
parser = argparse.ArgumentParser(description='Temporal Deep Kernel Single Task SVDKGP model for a single DLMUSE Roi')
...
# Save model
model_filename = os.path.join(output_dir, f'population_svdkgp_{roi_idx}.pth')
